...
plt.axhline(y=896.336, color = 'orange', linestyle = '-', label = 'Hüllkurven-Minima $U_{min}=896$mV')
...
plt.savefig("../Abbildungen/2/2.1/Modulationskennlinie.png", dpi=300, bbox_inches="tight")

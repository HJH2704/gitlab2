...
# --- Konfiguration ---
# --- Konfiguration ---
INPUT_PATH1 = "./Data/tabelle_3_11.txt"  
INPUT_PATH2 = "./Data/tabelle_3_12.txt"
INPUT_PATH3 = "./Data/tabelle_3_13.txt"   # Eingabedatei mit LaTeX-Tabellenzeilen
OUT_DIR = "../Abbildungen/3/1"           # Ausgabeordner
os.makedirs(OUT_DIR, exist_ok=True)

TIMESTAMP = datetime.now().strftime("%Y%m%d_%H%M%S")
PNG_PATH1 = os.path.join(OUT_DIR, f"Messspektrum_Sinus_{TIMESTAMP}.pdf")
PNG_PATH2 = os.path.join(OUT_DIR, f"Messspektrum_Dreieck_{TIMESTAMP}.pdf")
PNG_PATH3 = os.path.join(OUT_DIR, f"Messspektrm_Rechteck_{TIMESTAMP}.pdf")
...
if __name__ == "__main__":
    ...
    for col in range(ys.shape[1]):
        ...
        plt.title("Messspektrum Sinussignal m = 10")       
        plt.grid(True)
        plt.tight_layout()
...
if __name__ == "__main__":
    ...
    for col in range(ys.shape[1]):
        ...
        plt.xlabel("Spektrallinien in MHz")
        plt.ylabel("Amplitude")
        plt.title("Messspektrum Dreieck m = 10")       
        plt.grid(True)
        plt.tight_layout()
...
if __name__ == "__main__":
    ...
    for col in range(ys.shape[1]):
        ...
        plt.xlabel("Spektrallinien in MHz")
        plt.ylabel("Amplitude")
        plt.title("Messspektrum Rechteck m = 10")       
        plt.grid(True)
        plt.tight_layout()
